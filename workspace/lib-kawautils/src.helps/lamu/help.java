...
import lamu.lib.helps.KawapadDocumentFormatter;
import lamu.lib.helps.LamuDocument;
import lamu.lib.helps.LamuDocumentCondition;
import lamu.lib.helps.LamuDocumentFormatterUtil;
...
public class help implements Runnable {
    ...
    public static void defineHelp() {
        SchemeEvaluation.executeInTheCurrentContext(
            "(define-syntax help\n" + 
            "   (syntax-rules ()\n" + 
            "     ((help help-target)\n" + 
