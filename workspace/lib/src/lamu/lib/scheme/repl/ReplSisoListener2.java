...
/**
 * An older version of {@link ReplSisoListener}. This version adopts the
 ...
 * 
 * For further information, see the new {@link ReplSisoListener}.
 */
public class ReplSisoListener2 implements SisoProcessor, SisoListener {
    ...
    public ReplSisoListener2( SchemeEngine schemeEngine ) {
        super();
        this.schemeEngine = schemeEngine;
    }
    public ReplSisoListener2( SchemeEngine schemeEngine, String prefix ) {
        super();
        this.schemeEngine = schemeEngine;
        this.prefix = prefix;
    }
...
//        }
    ...
    public static void main(String[] args) {
        ...
        new SisoReceiver( null, System.in, System.out, new ReplSisoListener2( schemeEngine, ";" ) ).requestInit();
    }
}
