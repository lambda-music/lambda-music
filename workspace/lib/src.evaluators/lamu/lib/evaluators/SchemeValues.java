...
//    }
    ...
    static Object assq( Object key, Object alist ) {
        try {
    ...
    static Object car( Object object ) {
        try {
    ...
    static Object cdr( Object object ) {
        try {
    ...
    public static List<String> getAllKey( Evaluator evaluator ) {
        ...
        result.throwIfError();
        return new ArrayList<>( toStringList((LList)result.getValue()));
    }
