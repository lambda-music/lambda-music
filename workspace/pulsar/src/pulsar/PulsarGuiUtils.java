...
//	}
	...
	public static Object guiBuild( Pulsar pulsar, Object[] args) {
		return guiBuild2( pulsar, args );
	}

	@SuppressWarnings("unused")
	private Object guiBuild1( Pulsar pulsar, Object[] args) {
		Container parent;
	...
	private static Object guiBuild2( Pulsar pulsar, Object[] args) {
	...
	static void initStaticScheme( Pulsar pulsar, Scheme scheme ) {
		...
		SchemeUtils.defineVar( scheme, "gui-pack" , new ProcedureN("gui-pack") {
			@Override
		...
		SchemeUtils.defineVar( scheme, "gui-new" , new ProcedureN("gui-new") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				//				try {
		...
		SchemeUtils.defineVar( scheme, "gui-parent" , new ProcedureN("gui-parent") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 <= args.length ) {
		...
		SchemeUtils.defineVar( scheme, "gui-remove-all" , new ProcedureN("gui-remove-all") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 <= args.length ) {
					ArrayDeque<Object> argList = new ArrayDeque<>( Arrays.asList(args) );
		...
		SchemeUtils.defineVar( scheme, "gui-remove-by-ref" , new ProcedureN("gui-remove-by-ref") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 < args.length ) {
					ArrayDeque<Object> argList = new ArrayDeque<>( Arrays.asList(args) );
		...
		SchemeUtils.defineVar( scheme, "gui-remove-by-name" , new ProcedureN("gui-remove-by-name") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 < args.length ) {
					ArrayList<Object> argList = new ArrayList<>( Arrays.asList(args) );
		...
		SchemeUtils.defineVar( scheme, "gui-invoke-later" , new ProcedureN("gui-invoke-later") {
			@Override
			public Object applyN( Object[] args ) throws Throwable {
		...
		SchemeUtils.defineVar( scheme, "gui-get" , new ProcedureN("gui-get") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 == args.length ) {
					Container parent = (Container) args[0];
		...
		SchemeUtils.defineVar( scheme, "gui-set-selected" , new ProcedureN("gui-set-selected") {
			public Object applyN(Object[] args) throws Throwable {
				if ( 3 == args.length ) {
		...
		SchemeUtils.defineVar( scheme, "gui-set-text" , new ProcedureN("gui-set-text") {
			public Object applyN(Object[] args) throws Throwable {
				if ( 2 == args.length ) {
		 ...
		 */
		SchemeUtils.defineVar( scheme, "gui-set-user-object" , new ProcedureN("gui-set-user-object") {
			public Object applyN(Object[] args) throws Throwable {
				if ( 2 == args.length ) {
		...
		SchemeUtils.defineVar( scheme, "gui-get-user-object" , new ProcedureN("gui-get-user-object") {
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 == args.length ) {
					JPulsarUserObject parent = (JPulsarUserObject) args[0];
		...
		// XXX
		SchemeUtils.defineVar( scheme, "gui-prettify" , new ProcedureN("gui-prettify") {
			public Object applyN(Object[] args) throws Throwable {
				if ( 1 == args.length ) {
		...
		SchemeUtils.defineVar( scheme, "gui-build" , new ProcedureN("gui-build") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				return guiBuild( pulsar, args );
			}
		});
		SchemeUtils.defineVar( scheme, "gui-newline" , new ProcedureN("gui-newline") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				logInfo("newline-gui");
				if ( args.length == 0 )
		...
		//    	SchemeUtils.defineVar( scheme, "gui-repaint" , new ProcedureN("gui-repaint") {
		//			@Override
		//    		public Object applyN(Object[] args) throws Throwable {
		////					logInfo("refresh-gui");
		//				guiRepaint();
		...
		//    		}
		//    	});
		SchemeUtils.defineVar( scheme, "gui-layout" , new ProcedureN("gui-layout") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				logInfo( "gui-layout" );
		...
		SchemeUtils.defineVar( scheme, "gui-gridbag-layout" , new ProcedureN("gui-gridbag-layout") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
		...
		SchemeUtils.defineVar( scheme, "gui-spring-layout" , new ProcedureN("gui-spring-layout") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
		...
		SchemeUtils.defineVar( scheme, "gui-flow-layout" , new ProcedureN("gui-flow-layout") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
		...
		SchemeUtils.defineVar( scheme, "gui-put-constraint" , new ProcedureN("gui-put-constraint") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
				logInfo("refresh-gui");
		...
		SchemeUtils.defineVar( scheme, "gui-invalidate" , new ProcedureN("gui-invalidate") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
		...
		SchemeUtils.defineVar( scheme, "gui-validate" , new ProcedureN("gui-validate") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
		...
		SchemeUtils.defineVar( scheme, "gui-revalidate" , new ProcedureN("gui-revalidate") {
			@Override
			public Object applyN(Object[] args) throws Throwable {
