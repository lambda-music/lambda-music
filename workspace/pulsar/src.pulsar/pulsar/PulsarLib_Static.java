...
public final class PulsarLib_Static {
    ...
    @SourceName(name = "filt")
    public static final Procedure newFilterTrackProc = new NewRecordTrackProc( new String[] { "new-filter-track", "filt" });
    public static final class NewFilterTrackProc extends MultipleNamedProcedureN {
        public NewFilterTrackProc(String[] names) {
            super(names);
        }
        ...
        public Object applyN(Object[] args) throws Throwable {
            ...
            case 3 : 
            {
                ...
                return PulsarCommon.createDynamicProcedureFilterSequenceFactory( portSelector, procedure );
            }
