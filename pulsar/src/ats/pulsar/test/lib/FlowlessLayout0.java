 ...
 */
public class FlowlessLayout0 implements LayoutManager, java.io.Serializable {
     ...
     */
    public FlowlessLayout0(int align) {
        this(align, 5, 5);
    }
     ...
     *                     borders of the <code>Container</code>
     */
    public FlowlessLayout0(int align, int hgap, int vgap) {
        this.hgap = hgap;
        this.vgap = vgap;
        setAlignment(align);
    }
